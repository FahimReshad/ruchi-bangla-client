  ...
  return (
    <div className="relative">
      <img
        ...
        alt=""
      />
      <div className="text-2xl md:text-4xl lg:text-6xl font-bold absolute top-1/3 lg:top-44 right-28 md:right-72 lg:right-1/3 lg:mr-20  text-red-600 text-center md:space-y-6">
