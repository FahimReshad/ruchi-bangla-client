    ...
    <div className="flex lg:h-screen items-center justify-center bg-[#dd5903]/20 p-6 md:p-0">
      ...
      <div className="flex flex-col lg:flex-row h-full w-full overflow-hidden rounded-lg shadow-md  md:h-[90%] md:w-[80%] lg:h-[80%] items-center">
        ...
        <div className="flex w-full flex-col justify-center  py-10 lg:w-[60%]">
          <h2 className="pb-8 text-center text-4xl font-bold text-[#AD1A19] font-barlow">
            Login Here
          </h2>
          <form
          ...
          >
            <input
              className="w-[80%] rounded-lg border border-[#AD1A19] px-6 py-2 focus:outline-none focus:ring-2 focus:ring-[#dd5903]/50 md:w-[60%]"
              type="email"
              placeholder="Email"
              name="email"
            />
            ...
            <p className="text-lg font-semibold text-gray-700 font-barlow">
              ...
              <Link to="/register" className="text-[#AD1A19] ">
                Please Register
              </Link>
            </p>
            <input
              className="w-[80%] rounded-lg bg-[#AD1A19] px-6 py-2 font-medium text-white md:w-[60%]"
              type="submit"
            />
          </form>
          {/* divider  */}
          ...
          <div className="flex gap-6 mx-auto w-1/2">
            ...
            >
              <div className="flex h-full w-[50%] items-center bg-[#AD1A19] pl-4 text-sm text-white font-semibold">
                Sign With
              </div>
              <span className="right-0 top-0 h-0 w-0 -rotate-90 border-b-[50px] border-r-[50px] border-b-transparent border-r-[#AD1A19] group-hover:hidden"></span>
            ...
            <div
              ...
              className="mx-auto flex h-[50px] w-[200px] items-center overflow-hidden rounded-full shadow-md duration-300 hover:scale-95 hover:shadow"
            >
              <div className="flex h-full w-[50%] items-center bg-[#AD1A19] pl-4 text-sm text-white hover:cursor-pointer font-semibold">
                Sign With
              </div>
              <span className="right-0 top-0 h-0 w-0 -rotate-90 border-b-[50px] border-r-[50px] border-b-transparent border-r-[#AD1A19] group-hover:hidden"></span>
