		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 w-full lg:w-2/3 lg:grid-cols-4 font-semibold lg:mr-40">
			<div className="space-y-3">
				...
				<ul className="space-y-1 text-lg text-[#C6C6C6]">
					<li>
						<a className='flex items-center gap-2' rel="noopener noreferrer" href="#"><span><BiSolidPhoneCall></BiSolidPhoneCall></span> +880 1330927666</a>
					</li>
					<li>
						<a className='flex items-center gap-2' rel="noopener noreferrer" href="#"><span><FaLocationDot></FaLocationDot></span>Pahartali, Chattogram</a>
					</li>
					<li>
						<a className='flex items-center gap-2' rel="noopener noreferrer" href="#"><span><MdEmail />
</span>ruchibangla@gmail.com</a>
					</li>
				</ul>
			</div>
