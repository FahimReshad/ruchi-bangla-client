      ...
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-[20%]">
          <a rel="noopener noreferrer" href="#" className="">
            <h2 className="lg:-ml-10 text-3xl font-bold text-[#8F3034]">
              Ruchi Bangla
            </h2>
            <p className="text-lg text-[#C6C6C6] lg:-ml-10 mt-4 font-barlow">
              Discover authentic Bangladeshi recipes and culinary inspiration at
              Ruchi Bangla.
            </p>
          </a>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 w-full lg:w-2/3 lg:grid-cols-4 font-semibold lg:mr-40">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-white font-black font-barlow text-3xl">
              Our Address
            </h3>
          ...
          <div className="space-y-3 lg:ml-20 lg:w-[400px]">
            <h3 className="tracking-wide uppercase text-white font-bold font-barlow text-3xl">
              Working Hours
            </h3>
          ...
          <div className="space-y-3 lg:ml-40 lg:w-[200px]">
            <div className="uppercase text-white font-bold font-barlow text-xl">
              Social media
            </div>
