  ...
  return (
    <div>
      <div className="text-center my-16">
        <h2 className="text-4xl font-bold font-barlow text-[#AD1A19]">
          Our top Foods
        </h2>
        <p className="md:w-3/5 lg:w-1/3 mx-auto mt-6 text-xl font-barlow font-semibold">
          Discover our top-selling dishes, loved by our customers around the
          clock! From traditional favorites to modern delights, explore our most
          popular dishes that keep our customers coming back for more.
        </p>
      </div>
      <section className="container mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
        {showTopFood.map((topFood) => (
          <div key={topFood._id} className="">
      ...
      <div>
        <Link to="/allFoods">
          <button className="flex justify-center mx-auto mt-8 btn bg-[#AD1A19] text-xl font-bold font-barlow">
            See All Food
          </button>
        </Link>
      </div>
